...
class md5 { //_global.MD5 = new Object();
...
public function b64_md5 (s){
return this.binl2b64(this.core_md5(this.str2binl(s), s.length * this.chrsz));
}

public function str_md5 (s){
return this.binl2str(this.core_md5(this.str2binl(s), s.length * this.chrsz));
}

public function hex_hmac_md5 (key, data) {
return this.binl2hex(this.core_hmac_md5(key, data)); 
}

public function b64_hmac_md5 (key, data) { 
return this.binl2b64(this.core_hmac_md5(key, data));
}

public function str_hmac_md5 (key, data) {
...
//
public function core_md5 (x, len){
var olda;
var oldb;
var oldc;
var oldd; 
...
public function md5_cmn (q, a, b, x, s, t){
var result = this.safe_add(this.bit_rol(this.safe_add(this.safe_add(a, q), this.safe_add(x, t)), s),b);
return result;
}

public function md5_ff (a, b, c, d, x, s, t){
return this.md5_cmn((b & c) | ((~b) & d), a, b, x, s, t);
}

public function test (){};

public function md5_gg (a, b, c, d, x, s, t){
  return this.md5_cmn((b & d) | (c & (~d)), a, b, x, s, t);
}

public function md5_hh (a, b, c, d, x, s, t){
  return this.md5_cmn(b ^ c ^ d, a, b, x, s, t);
}

public function md5_ii (a, b, c, d, x, s, t){
...
//
public function core_hmac_md5 (key, data){
...
//
public function bit_rol (num, cnt){
 ...
 */
public function binl2hex (binarray){
